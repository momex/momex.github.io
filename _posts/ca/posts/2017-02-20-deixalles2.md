...
Com veieu, el líder en nombre de bosses és el plàstic (primera columna per l'esquerra), doblant pràcticament al segon que és l'orgànic (quarta columna per l'esquerra). Un altre punt interessant és que en mig any només hem generat 5 bosses de rebuig (General, tercera columna per l'esquerra).<br>
